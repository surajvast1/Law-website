        ...
        <footer id="footer">
            <div className="footer-main">
                ...
                <div className="container">
                    ...
                    <p>Stay in the loop with the latest news and updates by subscribing to our mailing list</p>
            ...
            <div className="grid-container">
                <div className='footer_data' >
                    <p className='footer_heading underline-heading'>START A BUSINESS</p>

                    <ul>
                        <li className='footer-data-first'>
                            <ul>
                                <li>
                                    <br />
                        ...
                        <li className='footer-data-first'>
                            <ul>
                                <li>
                                    <Link to="/">Farmer Producer Company</Link>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li className='footer-data-first'>
                            <ul>
                                <li>
                                    <Link to="/">Nidhi Company Registration</Link>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li className='footer-data-first'>
                            <ul>
                                <li>
                                    <Link to="/">Startup India Registration</Link>
                                </li>
                            </ul>
                        </li>
                    </ul>
                ...
                <div className='footer_data' >
                    <p className='footer_heading underline-heading'>TRADEMARK & COPYRIGHT</p>
                    ...
                    <ul>
                        <li className='footer-data-first'>
                            <ul>
                                <li>
                                    <br />
                                    <Link to="/">International Trademark Registration</Link>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li className='footer-data-first'>
                            <ul>
                                <li>
                                    <Link to="/">USA Trademark Registration</Link>
                                </li>
                            </ul>
                        </li>
                ...
                <div className='footer_data' >
                    <p className='footer_heading underline-heading'>CONVERT/CHANGE IN BUSINESS</p>
                    ...
                    <ul>
                        <li className='footer-data-first'>
                            <ul>
                                <li>
                                    <br />
                                    <Link to="/">Partnership to LLP</Link>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li className='footer-data-first'>
                            <ul>
                                <li>
                                    <Link to="/">Private to One Person Company</Link>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li className='footer-data-first'>
                            <ul>
                                <li>
                                    <Link to="/">Private to Public Limited Company</Link>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li className='footer-data-first'>
                            <ul>
                                <li>
                                    <Link to="/">Change Objective of Business</Link>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li className='footer-data-first'>
                            <ul>
                                <li>
                                    <Link to="/">Change Company Name</Link>
                                </li>
                            </ul>
                        </li>
                    </ul>
                ...
                <div className='footer_data' >
                    <p className='footer_heading underline-heading'>LEGAL DOCUMENTATION</p>
                    ...
                    <ul>
                        <li className='footer-data-first'>
                            <ul>
                                <li>
                                    <br />
                                    <Link to="/">Term Sheet Agreement</Link>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li className='footer-data-first'>
                            <ul>
                                <li>
                                    <Link to="/">Non Compete Agreement</Link>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li className='footer-data-first'>
                            <ul>
                                <li>
                                    <Link to="/">Finance Agreement</Link>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li className='footer-data-first'>
                            <ul>
                                <li>
                                    <Link to="/">Freelancer Agreement</Link>
                                </li>
                            </ul>
                        </li>
                    </ul>
            ...
            <br />
            <div>
                <button className="tf-button-st2 btn-effect all-service-button" type="submit" id="subscribe-button" style={{ display: "block", margin: "0 auto" }}> <span className="effect">See all the services</span></button>
            </div>
            <br /><br />
                ...
                <div className="container">
                    <div className="wrap-fx">
                        <div className="Copyright">
                            <p>E-CORP 2023- ALL rights reserved</p>
                        </div>
                        <ul className="list">
                            <li>
